...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
    ...
    // by definition!
    {
        vector<VertexFormat> verticesTwo
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
        ...
        vector<unsigned int> indicesTwo =
        {
            0,2,1,
            0,4,2,
            4,2,1,
        ...
        meshes["tetrahedron"]->InitFromData(verticesTwo, indicesTwo);
    }

    // TODO(student): Create a square using two triangles with
    // opposing vertex orientations.
    {
        vector<VertexFormat> verticesThree
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1.0f, 0.5f, 0.31f),glm::vec3(0, 1, 0),glm::vec2(1)),
        ...
        vector<unsigned int> indicesThree =
        {
            0,2,1,
            1,3,2,
        ...
        meshes["square_A"] = new Mesh("generated square");
        meshes["square_A"]->InitFromData(verticesThree, indicesThree);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(3.0f, -0.5f, 0), glm::vec3(3.0f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], glm::vec3(1, 1, 0), glm::vec3(0.2f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square_A"], glm::vec3(0, 0, 0), glm::vec3(5.0f));
